...
namespace FuncDoodle {
    class Grid
    {
        public:
            ...
            ~Grid();
            void RenderWithDrawList(ImDrawList* drawList, ImVec2 startPos, ImVec2 endPos);
            ...
            inline const void SetGridWidth(int gridWidth) { m_GridWidth = gridWidth; }
            inline const void SetGridHeight(int gridHeight) { m_GridHeight = gridHeight; }
